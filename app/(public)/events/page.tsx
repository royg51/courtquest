  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <section className="mt-12">
        <h2 className="mb-4 text-lg font-semibold text-gray-900">Past Tournaments</h2>
        <div className="space-y-6">
          {PAST_EVENTS.map((event) => (
            <div key={event.name} className="rounded-lg border border-gray-200 p-6">
              ...
              {event.cause && <p className="mt-3 text-sm text-gray-700">{event.cause}</p>}
