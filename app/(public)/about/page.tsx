...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      <h1 className="text-2xl font-bold text-brand-700">About CourtQuest</h1>
      ...
      <section className="mt-10">
        <h2 className="font-semibold text-gray-900">Our Story</h2>
        <p className="mt-2 text-sm leading-relaxed text-gray-600">
      ...
      <section className="mt-12">
        <h2 className="mb-6 font-semibold text-gray-900">Timeline</h2>
        <ol className="relative space-y-8 border-l border-gray-200 pl-8">
          {TIMELINE.map(({ date, title, icon: Icon }) => (
            <li key={title} className="relative">
              <span className="absolute -left-[2.45rem] flex h-8 w-8 items-center justify-center rounded-full bg-brand-50 text-brand-600 ring-4 ring-white">
