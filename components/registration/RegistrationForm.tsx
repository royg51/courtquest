    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-md space-y-4 px-4 py-8" noValidate>
      ...
      {teamSize === 2 && (
        <fieldset className="space-y-3 rounded-md border border-gray-200 p-3">
          <legend className="px-1 text-sm font-medium text-gray-700">Partner</legend>
          <TextField
            label="Partner name"
      ...
      <div>
        <label className="flex items-start gap-2 text-sm text-gray-700">
          <input
            ...
            className="mt-1 h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500/40"
          />
